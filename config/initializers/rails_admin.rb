# RailsAdmin config file. Generated on January 24, 2013 17:25
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['The Question Project', 'Admin']
  ...
  # config.excluded_models = ['Answer', 'Question']

  # Include specific models (exclude the others):
  # config.included_models = ['Answer', 'Question']
